...
class WC_Shortcodes {
	...
	public static function init() {
		$shortcodes = array(
			...
			'woocommerce_my_shop'     	 => __CLASS__ . '::my_shop',
			'woocommerce_my_manager'     => __CLASS__ . '::my_manager',
		);
	...
	public static function my_shop( $atts ) {
		return self::shortcode_wrapper( array( 'WC_Shortcode_My_Shop', 'output' ), $atts );
	}
	public static function my_manager( $atts ) {
		return self::shortcode_wrapper( array( 'WC_Shortcode_My_Manager', 'output' ), $atts );
	}
