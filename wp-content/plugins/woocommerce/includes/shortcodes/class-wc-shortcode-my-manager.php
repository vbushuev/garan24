...
class WC_Shortcode_My_manager {
	...
	public static function output( $atts ) {
		...
		if ( ! is_user_logged_in() ) {
			...
			$message = apply_filters( 'woocommerce_my_manager_message', '' );
			...
			if ( isset( $wp->query_vars['lost-password'] ) ) {
				...
				wc_get_template( 'mymanager/form-login.php' );
	...
	private static function my_account( $atts ) {
		...
		wc_get_template( 'mymanager/my-account.php', array(
	...
	private static function view_order( $order_id ) {
		...
		wc_get_template( 'mymanager/view-order.php', array(
	...
	private static function edit_account() {
		...
		wc_get_template( 'mymanager/form-edit-account.php', array( 'user' => get_user_by( 'id', get_current_user_id() ) ) );
	}
	...
	private static function edit_address( $load_address = 'billing' ) {
		...
		wc_get_template( 'mymanager/form-edit-address.php', array(
	...
	public static function lost_password() {
		...
		wc_get_template( 'mymanager/form-lost-password.php', $args );
	}
